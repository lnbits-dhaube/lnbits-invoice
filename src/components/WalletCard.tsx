                ...
                <span className="flex items-center ">
                    {showBalance ? (
                        <span className="flex flex-col">
                            ...
                            <span className="text-sm font-bold align-bottom " >₿{btcBalance}</span>
                        </span>
                    ) : (
                        <span className="flex flex-col">
                            <span className="text-3xl font-bold">$**.***</span> 
                            <span className="text-sm font-bold align-bottom " >₿*.********</span>
                        </span>

                    )}
                    <button className="text-white border px-2 py-1 rounded-lg ml-2"
