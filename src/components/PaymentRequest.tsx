            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-14 text-lg md:text-lg"
                />
                <div className="relative flex flex-row gap-4 my-4 items-center justify-center">
                  <button
                    className={`flex-col text-gray-500  border shadow-xs rounded-md w-12 h-10 ${
                      amount === 10 ? "bg-green-600 text-white" : ""
                    }`}
                  ...
                  <button
                    className={`flex-col text-gray-500 border shadow-xs rounded-md w-12 h-10 ${
                      amount === 20 ? "bg-green-600 text-white" : ""
                    }`}
                  ...
                  <button
                    className={`flex-col text-gray-500 border shadow-xs rounded-md w-12 h-10 ${
                      amount === 40 ? "bg-green-600 text-white" : ""
                    }`}
                  ...
                  <button
                    className={`flex-col text-gray-500 border shadow-xs rounded-md w-12 h-10 ${
                      amount === 50 ? "bg-green-600 text-white" : ""
                    }`}
                  ...
                  <button
                    className={`flex-col text-gray-500 border shadow-xs rounded-md w-12 h-10 ${
                      amount === 100 ? "bg-green-600 text-white" : ""
                    }`}
